...
boy = ['James Castillo', 'Ryan Garcia', 'Froilan Santos', 'Sean Mendoza', 'Jake Delacruz', 'Armon Pedrezuela', 'Mj Polloso', 'Ricky Pacheco', 'Denver Reyes', 'Karl Perez', 'Cedrick Valino', 'Gerald Peralta', 'Gerry Paloma', 'Jack Rosales', 'Darren Yap', 'Joshua Villanueva', 'Harry Tiongson', 'Brent Espino', 'Frank Molino', 'Ralph Tanyag', 'Jaycent Amopas']
