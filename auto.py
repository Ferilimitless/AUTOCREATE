...
def main():
    ...
    if year_select in ['A','a','01','1']:os.system("xdg-open https://t.me/trickerxx77");old_2011_2014()
    elif year_select in ['B','b','02','2']:os.system("xdg-open https://t.me/trickerxx77");old_2009_2010()
